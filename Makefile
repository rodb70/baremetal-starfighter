...
PROGNAME = StarFighter

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o title.o KusInt.o TurInt.o explosion1.o explosion2.o explosion3.o text.o font.o Bullet.o RedBullet.o HealthPickup.o ShotgunPickup.o GameOverScreen.o TurMissCorv.o Missile.o ShieldPickup.o RocketPickup.o Rocket.o TurCorv.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = title.h KusInt.h TurInt.h explosion1.h explosion2.h explosion3.h text.h font.h Bullet.h RedBullet.h HealthPickup.h ShotgunPickup.h GameOverScreen.h TurMissCorv.h Missile.h ShieldPickup.h RocketPickup.h Rocket.h TurCorv.h
